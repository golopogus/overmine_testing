...
const grid_size_options = [[16,16],[50,50]]
...
var number_of_mines_per_chunk = 52
var unused_pos = []
var moveable = false
var local_mous_pos
...
func place_tile_loc(split, chunks):
	...
	upper_bounds_tiles = Vector2(chunk_size.x * chunks.x, chunk_size.x * chunks.x)
